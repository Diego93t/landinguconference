...
<html lang="es">
    <head>
        ...
        <meta charset="utf-8">
        <!--Esto para poner acentos a las palabras-->
    ...
    <body>
        ...
        <div class="container">
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                ...
                                <!--final del panel-body3-->
                            </div>
                            <!--fin del collapseThree-->
                        </div>
                        <!--fin del panel-default3-->
            ...
            <!--fin del bs-callout bs-callout-danger-->
        </div>
        <!--fin de col-md-10-->
        </div><!--fin de class=""-->
